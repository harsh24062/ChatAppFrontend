  ...
  return (
    ...
    <div className="">
        ...
        <div className=" border fixed bottom-0 w-full h-12 bg-gray-400 dark:bg-gray-600 border-white dark:border-gray-700 ">
            ...
            <button className="bg-red-500 dark:bg-blue-500 px-4 py-3 rounded-xl hover:bg-green-500 hover:scale-105 transition-all duration-200"> <MdSend size={20}/> </button>
            </div>
        </div>
